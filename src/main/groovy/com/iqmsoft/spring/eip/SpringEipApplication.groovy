package com.iqmsoft.spring.eip
...
class SpringEipApplication {
	...
	static void main(String[] args) {
		SpringApplication.run SpringEipApplication, args
	}
	...
	@InboundChannelAdapter(value = "rtqChannel", poller = @Poller(fixedRate = "5000", maxMessagesPerPoll = '1'))
	public BigDecimal foo() {
		new BigDecimal(new Random().nextDouble() * 1000)
	}
